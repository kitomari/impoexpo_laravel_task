                        ...
                        @foreach($short_links as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('disable_url',$row->id)}}" class="badge bg-primary py-2 px-3 btn-primary">Disable</a>
                                    <a href="{{url('delete_url', $row->id)}}" class="badge bg-danger py-2 px-3 btn-danger">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
